...
export default {
  ...
  data() {
    return {
      ...
      strings: {
        // Toolbar
        searchLabel: t('framaspace', 'Search'),
        searchPlaceholder: t('framaspace', 'Filter messages…'),
        refresh: t('framaspace', 'Refresh'),
        showForm: t('framaspace', 'Show form'),
        hideForm: t('framaspace', 'Hide form'),
        ...
        // Form
        formHeader: t('framaspace', 'Say hello'),
        nameInputLabel: t('framaspace', 'Name'),
        nameInputPlaceholder: t('framaspace', 'e.g. Ada'),
        themeLabel: t('framaspace', 'Theme'),
        add: t('framaspace', 'Add'),
        clear: t('framaspace', 'Clear'),
        livePreview: t('framaspace', 'Preview:'),

        // List
        loading: t('framaspace', 'Loading…'),
        emptyTitle: t('framaspace', 'No hellos yet'),
        emptyDesc: t('framaspace', 'Try adding one using the form above.'),
        addExample: t('framaspace', 'Add example'),
        colMessage: t('framaspace', 'Message'),
        colAt: t('framaspace', 'Time'),
        colActions: t('framaspace', 'Actions'),
        duplicate: t('framaspace', 'Duplicate'),
        remove: t('framaspace', 'Remove'),
        clearAll: t('framaspace', 'Clear all'),
