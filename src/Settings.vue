<template>
  <div id="framaspace-content" class="section">
    <h2>{{ strings.title }}</h2>
...
export default {
  ...
  data() {
    return {
      ...
      themeLabel: null,
      themeOptions: [
        { label: t('framaspace', 'Light'), value: 'light' },
        { label: t('framaspace', 'Dark'), value: 'dark' },
        {
          label: n('framaspace', 'System (1 option)', 'System (%n options)', 2),
          value: 'system',
        },
      ],
      ...
      strings: {
        // Titles / headers
        title: t('framaspace', 'Hello World — App Template'),
        infoTitle: t('framaspace', 'Information'),
        examplesHeader: t('framaspace', 'Quick Examples'),
        itemsHeader: t('framaspace', 'Editable List'),
        backendHeader: t('framaspace', 'Backend Calls'),
        ...
        // Name example
        nameInputHeader: t('framaspace', 'Boris Valero'),
        nameInputLabel: t('framaspace', 'Name'),
        nameInputPlaceholder: t('framaspace', 'e.g. Ada Lovelace'),
        livePreview: t('framaspace', 'Live preview:'),

        // Theme example
        themeHeader: t('framaspace', 'Theme'),
        themeLabel: t('framaspace', 'Choose a theme'),
        themePreview: t('framaspace', 'Active value:'),

        // Counter example
        counterHeader: t('framaspace', 'Counter'),
        plus: t('framaspace', '+1'),
        minus: t('framaspace', '-1'),

        // Items table
        newItemLabel: t('framaspace', 'New item'),
        newItemPlaceholder: t('framaspace', 'e.g. Hello item'),
        add: t('framaspace', 'Add'),
        clear: t('framaspace', 'Clear'),
        tableItem: t('framaspace', 'Item'),
        tableActions: t('framaspace', 'Actions'),
        editItemAria: t('framaspace', 'Edit item'),
        duplicate: t('framaspace', 'Duplicate'),
        remove: t('framaspace', 'Remove'),
        noItems: t('framaspace', 'No items yet'),

        // Backend
        fetchHello: t('framaspace', 'Fetch Hello'),
        save: t('framaspace', 'Save'),
        loading: t('framaspace', 'Loading…'),
        lastHelloAt: t('framaspace', 'Last hello at:'),
        never: t('framaspace', 'Never'),
        serverSaid: t('framaspace', 'Server said:'),
      },
    }
  },
  created() {
