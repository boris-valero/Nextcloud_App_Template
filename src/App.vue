...
export default {
  ...
  data() {
    return {
      ...
      basePath: '/apps/framaspace',
      strings: {
        title: t('framaspace', 'Hello World — App'),
        subtitle: t(
          'framaspace',
        ...
        searchPlaceholder: t('framaspace', 'Type to filter…'),
        navHome: t('framaspace', 'Home'),
        navExamples: t('framaspace', 'Examples'),
        navAbout: t('framaspace', 'About'),
      },
